...
namespace {
    ...
    constexpr const uint8_t kNamespaceLights = 0x07;
    constexpr const uint8_t kTagLights = 0x01;
    constexpr const char kLabelLights[] = "1";

    const Clusters::Descriptor::Structs::SemanticTagStruct::Type LightsTagList[] = {
        { 
            .namespaceID = kNamespaceLights,
            .tag         = kTagLights, 
            .label       = chip::Optional<chip::app::DataModel::Nullable<chip::Span<const char>>>(chip::app::DataModel::Nullable<chip::Span<const char>>(chip::Span<const char>(kLabelLights, sizeof(kLabelLights) - 1)))
        }
    };
...
DECLARE_DYNAMIC_ATTRIBUTE(Descriptor::Attributes::DeviceTypeList::Id, ARRAY, kDescriptorAttributeArraySize, 0), /* device list */
    ...
    DECLARE_DYNAMIC_ATTRIBUTE(Descriptor::Attributes::TagList::Id, ARRAY, 32, 0), /* Tag list */
...
int AddDeviceEndpoint(Device * dev, EmberAfEndpointType * ep, const Span<const EmberAfDeviceType> & deviceTypeList,
    const Span<DataVersion> & dataVersionStorage, chip::CharSpan epUniqueId, chip::EndpointId parentEndpointId = chip::kInvalidEndpointId)
{
    uint8_t index = 0;
    while (index < CHIP_DEVICE_CONFIG_DYNAMIC_ENDPOINT_COUNT)
    {
        if (nullptr == gDevices[index])
        {
            ...
            while (true)
            {
                ...
                err = emberAfSetDynamicEndpointWithEpUniqueId(index, gCurrentEndpointId, ep, dataVersionStorage, deviceTypeList, epUniqueId, parentEndpointId);
...
void ApplicationInit()
{
    ...
    SetTagList(3, Span<const Clusters::Descriptor::Structs::SemanticTagStruct::Type>(LightsTagList));
    ...
    AddDeviceEndpoint(&ComposedTempSensor1, &bridgedTempSensorEndpoint,
                      ...
                      Span<DataVersion>(gComposedTempSensor1DataVersions), chip::CharSpan("AABBCCDDEEFFGGHHIIJJKKLLMMNNOO01", strlen("AABBCCDDEEFFGGHHIIJJKKLLMMNNOO01")), gComposedDevice.GetEndpointId());
    AddDeviceEndpoint(&ComposedTempSensor2, &bridgedTempSensorEndpoint,
                      Span<const EmberAfDeviceType>(gComposedTempSensorDeviceTypes),
                      Span<DataVersion>(gComposedTempSensor2DataVersions), chip::CharSpan("AABBCCDDEEFFGGHHIIJJKKLLMMNNOO02", strlen("AABBCCDDEEFFGGHHIIJJKKLLMMNNOO02")), gComposedDevice.GetEndpointId());
    ...
    SetTagList(9, Span<const Clusters::Descriptor::Structs::SemanticTagStruct::Type>(LightsTagList));
    ...
    SetTagList(10, Span<const Clusters::Descriptor::Structs::SemanticTagStruct::Type>(LightsTagList));
    ...
    SetTagList(11, Span<const Clusters::Descriptor::Structs::SemanticTagStruct::Type>(LightsTagList));
    ...
    SetTagList(12, Span<const Clusters::Descriptor::Structs::SemanticTagStruct::Type>(LightsTagList));
